...
import ba.sum.fpmoz.imm.ui.fragments.classes.ListGrades;

public class TabbedOcjeneStudent extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabbed_ocjene_student);
        setTitle("");
