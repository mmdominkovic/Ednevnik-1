...
import ba.sum.fpmoz.imm.ui.adapters.SubjectAdapter;
...
public class ListSubjectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View classListView = inflater.inflate(R.layout.activity_subject_list, container, false);
        this.subjectListView=classListView.findViewById(R.id.subjectListView);
