...
import ba.sum.fpmoz.mim.ui.adapters.SubjectsProfesorAdapter;
...
public class ListSubjectsInStudent extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View userListView = inflater.inflate(R.layout.activity_subjects_in_students_list, container, false);
